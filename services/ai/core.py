    ...
    def _initialize_models(self):
        ...
        try:
            if self.config.text_model_name:
                ...
                logger.info(f"Text/Vision model '{self.config.text_model_name}' loaded for AICoreService.")
        except Exception as e:
            logger.error(f"AICoreService model initialization failed: {e}", exc_info=True)
